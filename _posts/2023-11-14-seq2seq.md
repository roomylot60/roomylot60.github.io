...
date: 2023-11-14 15:12:00-0400
description: Sequence-to-sequence Algorithm
tags: NLP
categories: concept
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/BLEU.jpg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
    <br>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/Brevity_Penalty.jpg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
